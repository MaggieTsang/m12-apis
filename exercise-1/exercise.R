...
years.data <- GET("http://data.unhcr.org/api/stats/time_series_years.json")
body <- content(years.data,"text")
total.years <- fromJSON(body)

# What is the "country code" for the "Syrian Arab Republic"?
sar.code <- GET("http://data.unhcr.org/api/countries/list.json")
