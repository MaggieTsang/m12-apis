...
# to pass to the API. View the OMDb documentation to see which parameters are available.
query.parameters <- list( s = fav.movie, r = "json")
...
movie.data <- fromJSON(base.url)

# Make movie_data into a data frame using as.data.frame
dataframe.movies <- as.data.frame(movie.data)
