...
GetReview <- function(movie) {
  ...
  main.url <- 'https://api.nytimes.com/svc/movies/v2/reviews/search.json?'
  api.key <- "637b73d20e894e9080c16df0ce8c7a1b"
  query.parameters <- list(query = movie, api_key = api.key)
